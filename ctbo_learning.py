...
DIFFUSE_END_FRACTION = 0.15    # 40% of diffuse emissions remain in 2050
...
# Alternative linear ETS price trajectory (pounds)
ETS_LINEAR = True  # True: use linear trajectory, False: use CSV data
ets_linear_start = 45  # [GBP] in 2025
ets_linear_end = {"Low": 85, "Medium": 125, "High": 155}  # [GBP] in 2050, although CCC 7thCB uses 409 GBP by 2050
...
if ETS_LINEAR:
    # Linear trajectory from 45 GBP in 2025 to scenario-specific value in 2050
    ets_end = ets_linear_end[ETS]
    ets_prices = np.where(
        years <= 2050,
